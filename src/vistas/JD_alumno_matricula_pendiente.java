...
public class JD_alumno_matricula_pendiente extends JDialog implements ActionListener {
	...
	public static void main(String[] args) {
		try {
			JD_alumno_matricula_pendiente dialog = new JD_alumno_matricula_pendiente();
	 ...
	 */
	@SuppressWarnings({})
	public JD_alumno_matricula_pendiente() {
		setModal(true);
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(JD_alumno_matricula_pendiente.class.getResource("/imagenes/aac.jpg")));
		setResizable(false);
		setTitle("ALUMNO CON MATRICULA PENDIENTE");
		...
		desktopPane.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "ALUMNO REGISTRADOS", TitledBorder.LEFT, TitledBorder.TOP, null, new Color(0, 0, 0)));
		desktopPane.setBounds(10, 11, 670, 81);
		contentPanel.add(desktopPane);
		desktopPane.setLayout(null);

		lblname = new JLabel("Mostrar Alumnos Registrados");
		...
		btnConsultar.setIcon(new ImageIcon(JD_alumno_matricula_pendiente.class.getResource("/imagenes/buscar.png")));
		...
		btnSalir.setIcon(new ImageIcon(JD_alumno_matricula_pendiente.class.getResource("/imagenes/salir.png")));
	...
	protected void actionPerformedBtnConsultar(ActionEvent arg0) {
		...
		if (modelo.getRowCount() == 0) {
			mensaje("No existen alumnos con matricula pendiente");
		}
	}
